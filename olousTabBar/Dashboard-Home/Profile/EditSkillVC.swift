...
class EditSkillVC: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Edit Skills"
...
extension EditSkillVC : UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func fetchUserProfile() {
        ...
        let task = URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            do {
                ...
                print(user)
                self.addedSkillsArray = user.skills!
