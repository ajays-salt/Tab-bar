...
class AddEmploymentVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Add Employment"
...
//            return
//        }
        let alertController = UIAlertController(title: "Warning", message: "Do you want to proceed without adding Employment?", preferredStyle: .alert)
    ...
    func setupViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            start.topAnchor.constraint(equalTo: companyNameTextField.bottomAnchor, constant: 30),
    ...
    @objc func saveEmployment(_ sender: UIButton) {
        ...
        guard let companyNameField = sender.superview?.subviews[0] as? UITextField,
            ...
            companyNameTextField.placeholder = "Company can't be empty"
            companyNameTextField.layer.borderColor = UIColor.systemRed.cgColor
