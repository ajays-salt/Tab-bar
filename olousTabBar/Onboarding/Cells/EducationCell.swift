...
class EducationCell: UICollectionViewCell {
    ...
    private func setupUI() {
        ...
        [educationLabel, collegeLabel, passYearLabel, courseTypeLabel, editButton, deleteButton, separator].forEach { v in
            v.translatesAutoresizingMaskIntoConstraints = false
            addSubview(v)
        }
        
        NSLayoutConstraint.activate([
            educationLabel.topAnchor.constraint(equalTo: topAnchor),
            educationLabel.leadingAnchor.constraint(equalTo: leadingAnchor),
            educationLabel.trailingAnchor.constraint(lessThanOrEqualTo: trailingAnchor, constant: -25),
            
            collegeLabel.topAnchor.constraint(equalTo: educationLabel.bottomAnchor, constant: 8),
            collegeLabel.leadingAnchor.constraint(equalTo: leadingAnchor),
//            collegeLabel.widthAnchor.constraint(equalToConstant: 150),
            collegeLabel.trailingAnchor.constraint(lessThanOrEqualTo: trailingAnchor, constant: -25),
            
            passYearLabel.topAnchor.constraint(equalTo: collegeLabel.bottomAnchor, constant: 8),
            passYearLabel.leadingAnchor.constraint(equalTo: leadingAnchor),
